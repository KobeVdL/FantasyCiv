...
namespace FantasyCiv.GameElements
{
    ...
    class MapController : GameObject, MapListener// : GameObjectContainer<ArrayList>
    {
        ...
        {
            selectTiles(x, y, kstate);
        }

        private void selectTiles(int x, int y, KeyboardState kstate)
        {
            ...
            {
                this.handleReclickTile(selectedTile);
            }
            else
            {
        ...
        private void handleReclickTile(HexTile selectedTile)
        {
            if (selectedTile.hasUnit() && selectedUnits.Contains(selectedTile.unit))
            {
                selectedUnits.Remove(selectedTile.unit);
            }
            else
            {
